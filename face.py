...
def recognize_emotion():
    ...
    if pred == 0:
        tune = mp.newMedia(r"C:\Users\KRISHNAN\subhiksha\song_pred2\songs\angry_songs\angry.mp3")
        print("Don't be angry..we'll play a song to change your mood.")
    elif pred == 1:
        tune = mp.newMedia(r"C:\Users\KRISHNAN\subhiksha\song_pred2\songs\happy_songs\happy.mp3")
        print("You look great...Happy song is playing.")
    elif pred == 2:
        tune = mp.newMedia(r"C:\Users\KRISHNAN\subhiksha\song_pred2\songs\sad_songs\sad.mp3")
        print("Don't be sad..Let me play you a great song.Be happy.")
    elif pred == 3:
        tune = mp.newMedia(r"C:\Users\KRISHNAN\subhiksha\song_pred2\songs\neutral_songs\neutral.mp3")
        print("Neutral song is playing.")
    elif pred == 4:
        tune = mp.newMedia(r"C:\Users\KRISHNAN\subhiksha\song_pred2\songs\surprised_songs\surprised.mp3")
        print("wowww!!!!Surprise song is playing.")
